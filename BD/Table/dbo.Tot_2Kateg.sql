/*
		Internal system tables with Tot_2Kateg
...
USE [TotDB]
IF OBJECT_ID('dbo.Tot_2Kateg', 'U') IS NULL
    BEGIN
		CREATE TABLE [dbo].[Tot_2Kateg]
			(
			...
			CONSTRAINT [PK_Tot_2Kateg_ID] PRIMARY KEY CLUSTERED 
					(
					[id] ASC
