/*
		Internal system tables with Tot_7000
...
USE [TotDB]
IF OBJECT_ID('dbo.Tot_7000', 'U') IS NULL -- Проверка существования объекта ('U' - тип объекта )
    BEGIN
		CREATE TABLE [dbo].[Tot_7000]
				(
				...
				[tirag] [int] NULL,
					...
					CONSTRAINT [PK_Tot_7000_ID] PRIMARY KEY CLUSTERED ([id] ASC)
