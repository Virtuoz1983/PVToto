...
GO 
CREATE PROCEDURE [dbo].[Tot_InsertKuponsbyTirag](@KoefForTirag INT = 1)
	AS 
		BEGIN
			INSERT INTO [dbo].[Tot_Kupons]([tirag],[var1],[var2],[var3],[var4],[var5],[var6],[var7],[var8])
			SELECT tv1.tirag*@KoefForTirag, tv1.n, tv2.n, tv3.n, tv4.n, tv5.n, tv6.n, tv7.n, tv8.n
			FROM Tot_var1 tv1
